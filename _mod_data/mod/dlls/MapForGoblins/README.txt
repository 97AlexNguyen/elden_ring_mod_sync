Map For Goblins - DLL Edition v2.1.2
For VANILLA Elden Ring (base game + Shadow of the Erdtree).
~6900 loot & world-map icons. No regulation.bin changes.

Changes in v2.1.2:
- Fixed several crashes
- Fixed icons that could stay invisible on some game builds
- Fixed conflicts with overlay and frame-generation mods
- Better map screen performance
- New: setting for the marker tooltip / focus banner position (ultrawide displays)
